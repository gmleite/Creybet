...
public class UserRepository : IUserRepository
{
    ...
    public async Task<int> AddAsync(User entity)
    {
        ...
        {
            var result = await connection.ExecuteAsync(UserQueries.AddUser, new { entity.DiscordUserId, entity.Balance, entity.BetsLost, entity.BetsWon, entity.DidDailyCheckin });
            return result;
        }
    }
