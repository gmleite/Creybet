...
public class UserQueries
{
    ...
    public static string UpdateUser = @"UPDATE CreybetSchema.Users SET Balance = @Balance, BetsLost = @BetsLost, BetsWon = @BetsWon, DidDailyCheckin = @DidDailyCheckin WHERE DiscordUserId = @DiscordUserId";
